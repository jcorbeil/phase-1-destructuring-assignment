...
// 6) Object: uses destructuring to assign all appropriate variables using the keys as the variable names
...
// 7) Object: uses destructuring to assign songs 2 and 4, and Kermit's job and partner
const { song2, song4, nestedJob, nestedPartner } = {
  song1: 'Rainbow Connection',
  song2: 'Moving Right Along',
  song3: "It's Not Easy Being Green",
  song4: 'I Hope That Something Better Comes Along',
  nestedJob: 'Host of The Muppet Show',
  nestedPartner: 'Miss Piggy'
};
